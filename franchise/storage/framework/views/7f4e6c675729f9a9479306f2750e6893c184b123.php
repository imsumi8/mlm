                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="language" id="language" value="<?php echo e(old('language')); ?>" placeholder="<?php echo e(__('pages.language')); ?>" class="form-control" aria-describedby="emailHelp" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="iso_code" id="iso_code" value="<?php echo e(old('iso_code')); ?>" placeholder="<?php echo e(__('pages.iso_code')); ?>" class="form-control" aria-describedby="emailHelp">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/language/create.blade.php ENDPATH**/ ?>