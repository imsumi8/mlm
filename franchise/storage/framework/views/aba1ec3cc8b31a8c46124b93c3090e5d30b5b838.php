...
<div class="amd-wrapper" style="margin:0 auto; padding:0; max-width:1024px; width:100%; background:#fff;">
    ...
    <table style="width:100%; border-collapse: collapse; margin:auto; padding:0;">
        <tbody>
        <?php for($n = 0; $n < $numberOfCode; $n++): ?>
        <tr>
            <td class="barcode">
                <p style="margin-bottom: 0; padding-bottom:0; "> <?php echo e($product->sku); ?></p>
...
<?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/pdf/barcode-for-product.blade.php ENDPATH**/ ?>