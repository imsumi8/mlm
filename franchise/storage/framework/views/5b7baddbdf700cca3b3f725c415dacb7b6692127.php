                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hsn_code" id="hsn_code" value="<?php echo e(old('hsn_code')); ?>" placeholder="<?php echo e(__('pages.hsn_code')); ?>" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".1" name="dp" min="0" id="dp" value="<?php echo e(old('dp')); ?>" placeholder="<?php echo e(__('pages.dp')); ?>" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".1" name="bv" min="0" id="bv" value="<?php echo e(old('bv')); ?>" placeholder="<?php echo e(__('pages.bv')); ?>" class="form-control">
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/product/create.blade.php ENDPATH**/ ?>