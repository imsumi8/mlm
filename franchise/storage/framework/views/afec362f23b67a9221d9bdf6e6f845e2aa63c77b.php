                    ...
                    <div class="card mb-4 rounded-0">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="hsn_code"><?php echo e(__('pages.hsn_code')); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="hsn_code" id="hsn_code" value="<?php echo e($product->hsn_code); ?>" placeholder="<?php echo e(__('pages.hsn_code')); ?>" class="form-control">
                                        <?php if($errors->has('hsn_code')): ?>
                                            <div class="error"><?php echo e($errors->first('hsn_code')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="dp"><?php echo e(__('pages.dp')); ?> <span class="text-danger">*</span></label>
                                        <input type="number" step=".1" name="dp" min="0" id="dp" value="<?php echo e($product->dp); ?>" placeholder="<?php echo e(__('pages.dp')); ?>" class="form-control">
                                        <?php if($errors->has('dp')): ?>
                                            <div class="error"><?php echo e($errors->first('dp')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="bv"><?php echo e(__('pages.bv')); ?> <span class="text-danger">*</span></label>
                                        <input type="number" step=".1" name="bv" min="0" id="bv" value="<?php echo e($product->bv); ?>" placeholder="<?php echo e(__('pages.bv')); ?>" class="form-control">
                                        <?php if($errors->has('bv')): ?>
                                            <div class="error"><?php echo e($errors->first('bv')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/product/edit.blade.php ENDPATH**/ ?>