				...
				<div class="card mb-4 rounded-0">
					...
					<div class="card-header p-0">
						...
						<div class="btn-group btn-group-sm filter-pdf-btn" role="group">
							<form action="<?php echo e(url('report/sell/product-wise-pdf')); ?>" method="get">
							...
							<form action="<?php echo e(url('report/sell/product-wise-pdf')); ?>" method="get" target="_blank">
								<?php echo $__env->make('backend.report.sell.partial.hidden-filter-value-pdf', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/report/sell/product-wise/filter-result.blade.php ENDPATH**/ ?>