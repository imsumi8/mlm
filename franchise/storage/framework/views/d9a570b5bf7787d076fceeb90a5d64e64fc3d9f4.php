                                    ...
                                    <div class="card">
                                        <div class="box">
                                            ...
                                            <h2>
                                                ...
                                                <span><?php echo e(__('pages.hsn_code')); ?>: <?php echo e($product->hsn_code); ?></span>
                                            </h2>
                                            <p>
                                                ...
                                                <br>
                                                <span class="text-primary"> <?php echo e(__('pages.dp')); ?> : <?php $dpval= $product->sell_price - get_perc_value($product->sell_price,$product->dp); echo $dpval; ?>,</span>
                                                <span class="text-info"> <?php echo e(__('pages.bv')); ?>: <?php echo e(get_perc_value($dpval,$product->bv)); ?>,</span>
                                                <span class="text-danger">  <?php echo e($product->tax->title); ?>%</span>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/product/index.blade.php ENDPATH**/ ?>