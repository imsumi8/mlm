                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('save-application-setting')); ?>" method="post" class="form-horizontal" enctype="multipart/form-data">
                            ...
                            <div class="row  pt-3">
                                ...
                                <div class="col-md-4 mt-3">
                                    <div class="form-group">
                                        <label for="vat_reg_no"><?php echo e(__('pages.vat_reg_number')); ?> <span class="text-danger">*</span></label>
                                        <input name="vat_reg_no" id="vat_reg_no" type="text" value="<?php echo e(get_option('vat_reg_no')); ?>" class="form-control" placeholder="<?php echo e(__('pages.vat_reg_number')); ?>">
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="app_language" class="form-control select2">
                                            <?php $__currentLoopData = $languages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $language): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($language->iso_code); ?>" <?php echo e(get_option('app_language') == $language->iso_code ? 'selected' : ''); ?> ><?php echo e($language->language); ?></option>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </select>
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/settings/general.blade.php ENDPATH**/ ?>