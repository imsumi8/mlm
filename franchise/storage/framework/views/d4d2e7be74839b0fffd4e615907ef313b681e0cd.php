...
<main>
    ...
    <table class="table" width="100%" cellspacing="0">
        ...
        <tr class="bg-secondary text-white">
            ...
            <th width="25%"><?php echo e(__('pages.product_title')); ?></th>
            <th width="5%"><?php echo e(__('pages.purchase_qty')); ?></th>
            <th width="5%"><?php echo e(__('pages.sell_qty')); ?> </th>
            <th width="5%"><?php echo e(__('pages.current_stock_qty')); ?></th>
...
<?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/pdf/reports/stock/all-branch.blade.php ENDPATH**/ ?>