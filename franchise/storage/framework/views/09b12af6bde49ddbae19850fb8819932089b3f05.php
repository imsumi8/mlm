                                    ...
                                    <tr>
                                        ...
                                        <td class="font-14">
                                            <div class="btn-group btn-group-sm" role="group" aria-label="Basic example">
                                                ...
                                                <form action="<?php echo e(route('branch-restore-ok',['id' => $branch->id])); ?>" method="post" id="delete-<?php echo e($key); ?>"> <?php echo csrf_field(); ?> </form>
                                            </div>
                                        </td>
                                    </tr>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/trash/branches.blade.php ENDPATH**/ ?>