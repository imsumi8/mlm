                    ...
                    <div class="card-body">
                        <form action="<?php echo e(route('employee.store')); ?>" method="post" enctype="multipart/form-data" data-parsley-validate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pan_number"><?php echo e(__('pages.pan_number')); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="pan_number" id="pan_number" value="<?php echo e(old('pan_number')); ?>" placeholder="<?php echo e(__('pages.pan_number')); ?>" class="form-control" aria-describedby="emailHelp">
                                        <?php if($errors->has('pan_number')): ?>
                                            <div class="error"><?php echo e($errors->first('pan_number')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="gst_number"><?php echo e(__('pages.gst_number')); ?> <span class="text-danger">*</span> </label>
                                        <input type="text" name="gst_number" id="gst_number"  value="<?php echo e(old('gst_number')); ?>" placeholder="<?php echo e(__('pages.gst_number')); ?>" class="form-control" aria-describedby="emailHelp">
                                        <?php if($errors->has('gst_number')): ?>
                                            <div class="error"><?php echo e($errors->first('gst_number')); ?></div>
                                        <?php endif; ?>
                                    </div>
                                </div>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/backend/employee/create.blade.php ENDPATH**/ ?>