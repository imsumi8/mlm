...
<?php $__env->startSection('container'); ?>
    ...
    <div class="buttons">
        <a href="<?php echo e(url('/login')); ?>" class="button"> Login Your Account </a>
    </div>

<?php $__env->stopSection(); ?>

<?php echo $__env->make('vendor.installer.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/mybizfad/public_html/franchise/resources/views/vendor/installer/finished.blade.php ENDPATH**/ ?>