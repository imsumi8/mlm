                    ...
                    <div class="card mb-4 rounded-0">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label for="hsn_code">{{__('pages.hsn_code')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="hsn_code" id="hsn_code" value="{{$product->hsn_code}}" placeholder="{{__('pages.hsn_code')}}" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="dp">{{__('pages.dp')}} <span class="text-danger">*</span></label>
                                        <input type="number" step=".1" name="dp" min="0" id="dp" value="{{$product->dp}}" placeholder="{{__('pages.dp')}}" class="form-control">
                                        @if ($errors->has('dp'))
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="bv">{{__('pages.bv')}} <span class="text-danger">*</span></label>
                                        <input type="number" step=".1" name="bv" min="0" id="bv" value="{{$product->bv}}" placeholder="{{__('pages.bv')}}" class="form-control">
                                        @if ($errors->has('bv'))
                                            <div class="error">{{ $errors->first('bv') }}</div>
                                        @endif
                                    </div>
                                </div>
