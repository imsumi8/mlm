                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="hsn_code" id="hsn_code" value="{{old('hsn_code')}}" placeholder="{{__('pages.hsn_code')}}" class="form-control">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".1" name="dp" min="0" id="dp" value="{{old('dp')}}" placeholder="{{__('pages.dp')}}" class="form-control">
                                        @if ($errors->has('dp'))
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step=".1" name="bv" min="0" id="bv" value="{{old('bv')}}" placeholder="{{__('pages.bv')}}" class="form-control">
                                        @if ($errors->has('bv'))
