                    ...
                    <div class="card-body">
                        <form action="{{route('employee.store')}}" method="post" enctype="multipart/form-data" data-parsley-validate>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pan_number">{{__('pages.pan_number')}} <span class="text-danger">*</span></label>
                                        <input type="text" name="pan_number" id="pan_number" value="{{old('pan_number')}}" placeholder="{{__('pages.pan_number')}}" class="form-control" aria-describedby="emailHelp">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="gst_number">{{__('pages.gst_number')}} <span class="text-danger">*</span> </label>
                                        <input type="text" name="gst_number" id="gst_number"  value="{{old('gst_number')}}" placeholder="{{__('pages.gst_number')}}" class="form-control" aria-describedby="emailHelp">
                                        @if ($errors->has('gst_number'))
                                            <div class="error">{{ $errors->first('gst_number') }}</div>
                                        @endif
                                    </div>
                                </div>
