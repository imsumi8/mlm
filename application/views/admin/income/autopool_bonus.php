...
<!-- Main Content -->
                       ...
                       <div class="panel panel-default card-view panel-refresh pad_20">
							<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark">Autopool Bonus</h1>
									<hr class="reddish">
								</div>
		...
		<!-- CATEGORY TABLE								 -->
		<div class="panel-heading">Autopool Bonus</div>								
									<div class='col-md-12 col-sm-12' >
										...
										<table class='table-striped' id='income_list'
											data-toggle="table"
											data-url="<?php echo base_url()."admin_ajax/get_autopool_bonus?table=autopool_list" ?>"
...
<script>
    		...
    		$.ajax({    
    			type: 'POST',
    			url: admin_loc+'edit_autopool_bonus',
