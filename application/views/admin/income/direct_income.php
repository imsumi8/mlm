                       ...
                       <div class="panel panel-default card-view panel-refresh pad_20">
							<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark">Direct Income</h1>
									<hr class="reddish">
								</div>
            									...
            									<div  class="pills-struct">
            										...
            										<div class="tab-content" id="myTabContent_6">
            											<div  id="home_6" class="tab-pane fade active in" role="tabpanel">
            											    <form id="add_direct_income" action=''>
                                									...
                                									<div class="row">
                                										<div class="col-md-6">
                                											<div class="form-group">
                                												...
                                												<div><label>Direct Income<span class="star">*</span></label></div>
                                												<input type="text" name="direct_income"  class="form-control" autocomplete="off" value="<?php echo get_option('direct_income'); ?>"> 
                                											</div>
                                										</div>
...
<script>
          ...
          $("#add_direct_income").on('submit', function(e){
	
			e.preventDefault();
			$.ajax({
				type: 'POST',
				url: admin_loc+'add_direct_income',
