...
<!-- Main Content -->
                       ...
                       <div class="panel panel-default card-view panel-refresh pad_20">
							<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark">Manage Double Star Bonus</h1>
									<hr class="reddish">
								</div>
		...
		<!-- CATEGORY TABLE								 -->
		<div class="panel-heading">Double Star Bonus</div>								
									<div class='col-md-12 col-sm-12' >
										...
										<table class='table-striped' id='income_list'
											data-toggle="table"
											data-url="<?php echo base_url()."admin_ajax/get_double_bonus?table=double_bonus_list" ?>"
...
<script>
    		...
    		$.ajax({    
    			type: 'POST',
    			url: admin_loc+'edit_double_bonus',
