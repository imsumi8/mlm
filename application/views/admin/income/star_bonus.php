...
<!-- Main Content -->
                       ...
                       <div class="panel panel-default card-view panel-refresh pad_20">
							<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark">Manage Star Bonus</h1>
									<hr class="reddish">
								</div>
		...
		<!-- CATEGORY TABLE								 -->
		<div class="panel-heading">Star Bonus</div>								
									<div class='col-md-12 col-sm-12' >
										...
										<table class='table-striped' id='income_list'
											data-toggle="table"
											data-url="<?php echo base_url()."admin_ajax/get_star_bonus?table=star_bonus_list" ?>"
