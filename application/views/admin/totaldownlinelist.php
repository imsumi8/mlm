...
<!-- Main Content -->
		<div class="page-wrapper">
                    						...
                    						<div class="panel panel-default card-view pa-0">
                    							<div class="panel-wrapper collapse in">
                    								<div class="panel-body pa-0">
                    									<div class="sm-data-box dashboxes bg-red">
                    												...
                    												<div class="col-xs-8 text-center pl-0 pr-0 data-wrap-left">
                    												    ...
                    												    <div class="text-center txt-light">
                                                                            <div class="col-md-4 col-xs-4">
                                                                             ...
                                                                             <div class="col-md-4 col-xs-4">
                                                                                CENTER<div class="centerdown">0</div>
                                                                            </div>
                                                                            <div class="col-md-4 col-xs-4">
			...
			<footer class="footer container-fluid pl-30 pr-30">
				<div class="row">
					<div class="col-sm-12">
						<p>2018 &copy; MADHURAM. All rights reserved</p>
					</div>
				</div>
			</footer>
			<!-- /Footer -->
	                ...
	                $.ajax({
        				...
        				//	alert(msg[0]+" "+msg[1]+" "+msg[2]);
        					...
        					if(msg[1]===undefined){
        					    ...
        					    $('.centerdown').html(msg[1]);
        					    tot+=msg[1];
        					}
        					if(msg[2]===undefined){
        					    $('.rightdown').html('0');
        					}else{
        					    $('.rightdown').html(msg[2]);
        					    tot+=msg[2];
        					}
        					$('.total_down').html(tot);
        				}
