		...
		<div class="panel-body pa-0">
			<div class="sm-data-box bg-red">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
							<span class="weight-500 uppercase-font txt-light block font-13">Booster Income</span>
							<span class="txt-light block counter"><span class="counter-anim"><?php echo $team_spill=get_sum_wallet_balance_type($userid,11); ?></span></span>
						</div>
										...
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
													...
													<span class="txt-light block counter"><span class="counter-anim"><?php echo $team_sales + $by_self + $team_spill; ?></span></span>
												</div>
								...
								<div class="panel-body pa-0">
									<div class="sm-data-box actived">
										<div class="container-fluid">
											<div class="row">
												<div class="col-xs-12 text-center pl-0 pr-0 data-wrap-left">
													<span class="weight-500 uppercase-font txt-light block font-13"> Net Wallet (INCOME RS)</span>
													<span class="txt-light block counter"><span class="counter-anim"><?php echo liable_amount_to_pay($this->session->userdata('userid'));  ?></span></span>
												</div>
											</div>	
										</div>
									</div>
