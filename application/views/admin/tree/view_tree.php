<?php
    ...
    $query=$this->db->query('Select HRM_ID,HRM_NAME from hrm_post where PAY_STATUS=1 and HRM_ID!=5000 ORDER BY ID ASC');
    $result=$query->result();
    $large_arr=array();
...
<!-- Main Content -->
                                ...
                                <div class="col-lg-6 col-sm-6 col-md-6 col-xs-6 padding-top-icon text-right">
                                        <div class="row">
                                            <div class="col-md-offset-3 col-md-6 col-xs-offset-3 col-xs-6">
                                                <input type="text" id="tags" name="search" class="form-control searchno" placeholder="Search here by user id">
  ...
  <script>
    ...
    $(document).ready(function () {        
        ...
        var searchid='<?php echo $this->uri->segment(3); ?>';
