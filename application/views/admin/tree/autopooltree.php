...
<?php 
		 ...
		 if($hrm_id !=5000){
             $level1 = get_level_nodes($hrm_id,'TL1');
			 $level2 = get_level_nodes($hrm_id,'TL2');
             $level3 = get_level_nodes($hrm_id,'TL3');
             $level4 = get_level_nodes($hrm_id,'TL4');
			 $level5 = get_level_nodes($hrm_id,'TL5');
             $level6 = get_level_nodes($hrm_id,'TL6');
             $level7 = get_level_nodes($hrm_id,'TL7');
			 $level8 = get_level_nodes($hrm_id,'TL8');
			

		 }else{
            $level1 = get_all_level_nodes('TL1');
            $level2 = get_all_level_nodes('TL2');
            $level3 = get_all_level_nodes('TL3');
            $level4 = get_all_level_nodes('TL4');
            $level5 = get_all_level_nodes('TL5');
            $level6 = get_all_level_nodes('TL6');
            $level7 = get_all_level_nodes('TL7');
            $level8 = get_all_level_nodes('TL8');
		 }
				...
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
						...
						<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark">Triple Star Downline Members</h1>
									<hr class="reddish">
								</div>
