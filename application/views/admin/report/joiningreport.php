                       ...
                       <div class="panel panel-default card-view panel-refresh pad_20">
							<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark">Joining Report</h1>
									<hr class="reddish">
								</div>
								    ...
								    <div class="row">
								        <form action='' method="post">
    								        ...
    								        <div class="col-md-4">
    								            ...
    								            <button type="submit" class="btn btn-primary mrg_tp_25" name="searchjoining">Search</button>
    								        </div>
								        </form>
								    </div>
								    ...
								    <div class='box' id="print_area" class="panel-body" >
        								...
        								<div id="content">
        									<div id="tablewrapper">
        										...
        										<hr />
        										<h2 style="text-align: center;">User Joining Report </h2><h4 style="text-align: center;"> From : <?php echo date("M jS, Y", strtotime($_POST['from'])); ?>  To : <?php echo date("M jS, Y", strtotime($_POST['to'])); ?></h4>
												...
												<tbody>
													<?php if(!empty($result)) { $i=1; foreach($result as $results) { 
													     $arrlevel=hrm_level_track(1,$results->HRM_ID,3);
													    ?>
															<tr>
																<td><?php echo $i; ?></td>
																<td><?php echo $results->HRM_ID; ?></td>
																<td><?php echo $results->HRM_NAME; ?></td>
																<td><?php echo get_hrm_postmeta($arrlevel[0]->SPONSOR_ID,'first_name')." [ ".$arrlevel[0]->SPONSOR_ID." ] "; ?></td>
																<td><?php echo get_hrm_postmeta($arrlevel[0]->POSITION_ID,'first_name')." [ ".$arrlevel[0]->POSITION_ID." ] "; ?></td>
																<td><?php if($results->HRM_STATUS==1) { echo 'Active'; } else { echo "Inactive"; } ?></td>
																<td><?php echo date("M jS, Y", strtotime( $results->HRM_DATE)); ?></td>
															</tr>
														<?php $i++; } } else { ?>
