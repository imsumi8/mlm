                       ...
                       <div class="panel panel-default card-view panel-refresh pad_20">
							<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark"> <i class="fa fa-bar-chart"></i> Payout Released Report</h1>
									<hr class="reddish">
								</div>
								...
								<div class="panel-body">
								    <div class="row search_panel">
								        <form action='' method="post">
								             <div class="col-md-12">
								                 <h4>Member-wise Payout Report </h4>
								            </div>
								            <div class="col-md-3">
								                 <label>User Id : </label>
								    ...
								    <div class="row search_panel">
								        <form action='' method="post">
								             <div class="col-md-12">
								                 <h4>Month-wise Payout Report </h4>
								            </div>
    								        ...
    								        <div class="col-md-4 col-xs-6">
    								            <button type="submit" class="btn btn-primary mrg_tp_25" name="searchpayoutrelease_month">Search</button>
    								        </div>
								        </form>
								    </div>
								    ...
								    <div class='box' id="print_area" class="panel-body" >
        								...
        								<div id="content">
        									<div id="tablewrapper">
        										...
        										<hr />
        										<h2 style="text-align: center;">Payout Released Report </h2><h4 style="text-align: center;"> From : <?php echo date("M jS, Y", strtotime($_POST['from'])); ?>  To : <?php echo date("M jS, Y", strtotime($_POST['to'])); ?></h4>
												...
												<tbody>
												    ...
												    if(!empty($payout)) { $i=1; $amt=0; foreach($payout as $payouts) { 
												         $ledger=get_ledger_dt_by_id($payouts->CR_ID);
													     $user_id=str_replace("ledger_","",$ledger[0]->NAME);
													     $amt +=$payouts->AMOUNT;
													    ?>
															<tr>
																<td><?php echo $i; ?></td>
															    ...
															    <td><?php echo date("M jS, Y", strtotime($payouts->DATE)); ?></td>
															    <td><?php echo 'Paid'; ?></td>
															    <td><?php echo $payouts->AMOUNT; ?></td>
								    ...
								    <div class='box' id="print_area" class="panel-body" >
        								...
        								<div id="content">
        									<div id="tablewrapper">
        										...
        										<hr />
        										<h2 style="text-align: center;">Payout Report </h2><h4 style="text-align: center;"> From : <?php echo date("M jS, Y", strtotime($_POST['from1'])); ?>  To : <?php echo date("M jS, Y", strtotime($_POST['to1'])); ?></h4>
