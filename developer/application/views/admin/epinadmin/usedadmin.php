                       ...
                       <div class="panel panel-default card-view panel-refresh pad_20">
							<div class="panel-heading">
								<div class="text-center">
									<h1 class="panel-title txt-dark">Used E-PIN</h1>
									<hr class="reddish">
								</div>
											...
											<table class="table table-hover display  pb-30 datatabel_common" >
												...
												<tbody>
														...
														<?php if(!empty($epinunused)) { $i=1; foreach($epinunused as $epinunuse) { ?>
															<tr>
																<td><?php echo $i; ?></td>
																<td><?php echo $epinunuse->ISSUE_TO; ?></td>
																<td><?php echo $epinunuse->USED_BY; ?></td>
																...
																<!--<td><a href="<?php echo base_url(); ?>admin/epin/deletepinused/<?php echo $epinunuse->EPIN_ID; ?>" class="btn btn-success"><i class="fa fa-trash"></i></a></td>-->
															</tr>
														<?php $i++; } }else { ?>
